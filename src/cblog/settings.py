...
DATABASES = {
    'default': {
        ...
        'NAME': 'Homework', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'homework.c6qcr0omqyed.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'homework-website2' # please enter your s3 bucket name
